...
class ClaimPredictionRandomForest(ClaimPredictionBase):
    ...
    def fit_k_fold(self, n_estimators, random_state, max_features, max_depth, min_samples_split, min_samples_leaf):
        regression = RandomForestRegressor(n_estimators=n_estimators, random_state=random_state,
    ...
    def fit_hold_out(self, n_estimators, random_state, max_features, max_depth, min_samples_split, min_samples_leaf):
        regression = RandomForestRegressor(n_estimators=n_estimators, random_state=random_state, max_features=max_features, max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf)
